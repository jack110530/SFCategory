...
- (void)configBackIconWithPop:(UIImage *)popIcon dismiss:(UIImage *)dismissIcon; {
    ...
    switch (type) {
        ...
        {
            self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc]initWithImage:[popIcon imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] style:UIBarButtonItemStylePlain target:self action:@selector(back)];
        }
            break;
        case SFTranslationTypePresent:
        {
            self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc]initWithImage:[dismissIcon imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] style:UIBarButtonItemStylePlain target:self action:@selector(back)];
        }
            break;
